// This file was generated based on '/Users/coder/Library/Application Support/Fusetools/Packages/Fuse.Common/0.47.7/$.uno'.
...
{
    static uSStrong< ::g::Uno::Collections::List*> _currentDiagnostics_;
    static uSStrong< ::g::Uno::Collections::List*>& _currentDiagnostics() { return Diagnostics_typeof()->Init(), _currentDiagnostics_; }
    static uSStrong<uDelegate*> DiagnosticReported1_;
    static uSStrong<uDelegate*>& DiagnosticReported1() { return Diagnostics_typeof()->Init(), DiagnosticReported1_; }
    ...
    static uObject* ReportTemporal(::g::Fuse::Diagnostic* diag);
