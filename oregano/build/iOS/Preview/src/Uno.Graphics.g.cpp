...
// /Users/coder/Library/Application Support/Fusetools/Packages/UnoCore/0.47.13/source/uno/graphics/$.uno
// -----------------------------------------------------------------------------------------------------
...
static void Texture2D_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("/Users/coder/Library/Application Support/Fusetools/Packages/UnoCore/0.47.13/source/uno/graphics/$.uno");
    ...
    type->Reflection.SetFunctions(16,
        ...
        new uFunction("Update", NULL, (void*)Texture2D__Update2_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::IntPtr_typeof()));
}
...
// public void Update(Uno.IntPtr mip0) :1085
void Texture2D__Update2_fn(Texture2D* __this, void** mip0)
{
    __this->Update2(*mip0);
}
...
// public void Update(Uno.IntPtr mip0) [instance] :1085
void Texture2D::Update2(void* mip0)
{
    ...
    if (::g::Uno::String::StartsWith(uPtr(versionString), ::STRINGS[4/*"OpenGL ES "*/]))
    {
        ...
        catch (const uThrowable& __t)
        {
            if (uIs(__t.Exception, ::TYPES[1/*Uno.FormatException*/]))
            {
                ...
                ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::STRINGS[5/*"**** Invali...*/], versionString), 1, ::STRINGS[6/*"/Users/code...*/], 975);
            }
            else throw __t;
        }
    }
