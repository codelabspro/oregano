...
// public static extern Uno.IntPtr ct_face_create(Uno.IntPtr cgFont) :896
...
// public static extern Uno.IntPtr ct_face_create(Uno.IntPtr cgFont) [static] :896
...
{
    ::STRINGS[2] = uString::Const("UBiDi error: ");
}
...
// public static void CheckError(Fuse.Text.Implementation.ICU.ErrorCode errorCode) :1132
void ICU__CheckError_fn(int* errorCode)
{
    ICU::CheckError(*errorCode);
}

// private static Uno.IntPtr ErrorCString(Fuse.Text.Implementation.ICU.ErrorCode errorCode) :1148
void ICU__ErrorCString_fn(int* errorCode, void** __retval)
{
    *__retval = ICU::ErrorCString(*errorCode);
}

// private static int IsFailure(Fuse.Text.Implementation.ICU.ErrorCode errorCode) :1142
void ICU__IsFailure_fn(int* errorCode, int* __retval)
{
    *__retval = ICU::IsFailure(*errorCode);
}

// public static void CheckError(Fuse.Text.Implementation.ICU.ErrorCode errorCode) [static] :1132
void ICU::CheckError(int errorCode)
{
    ...
    if (ICU::IsFailure(errorCode) != 0)
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::STRINGS[2/*"UBiDi error: "*/], ::g::Fuse::Text::Implementation::CString::ToString(ICU::ErrorCString(errorCode)))));
}

// private static Uno.IntPtr ErrorCString(Fuse.Text.Implementation.ICU.ErrorCode errorCode) [static] :1148
void* ICU::ErrorCString(int errorCode)
{
    return (void*)u_errorName((::UErrorCode)errorCode);
}

// private static int IsFailure(Fuse.Text.Implementation.ICU.ErrorCode errorCode) [static] :1142
int ICU::IsFailure(int errorCode)
{
...
// public static Fuse.Text.Implementation.BitArray GetSoftLineBreaks(Fuse.Text.Substring text) :1447
...
// public static Fuse.Text.Implementation.ICU.ErrorCode ubrk(string text, int offset, int length, byte[] outBitArray) :1455
...
// public static Fuse.Text.Implementation.BitArray GetSoftLineBreaks(Fuse.Text.Substring text) [static] :1447
...
// public static Fuse.Text.Implementation.ICU.ErrorCode ubrk(string text, int offset, int length, byte[] outBitArray) [static] :1455
int UBrk::ubrk(uString* text, int offset, int length, uArray* outBitArray)
{
