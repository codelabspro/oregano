...
// public sealed extern class UITouch :1004
// {
...
// public UITouch(ObjC.Object handle) :1017
void UITouch__ctor__fn(UITouch* __this, ::g::ObjC::Object* handle)
{
    __this->ctor_(handle);
}

// private static bool Compare(ObjC.Object handle1, ObjC.Object handle2) :1100
...
// public override sealed bool Equals(object obj) :1042
...
// public override sealed int GetHashCode() :1049
...
// private static double GetTimestamp(ObjC.Object handle) :1092
void UITouch__GetTimestamp_fn(::g::ObjC::Object* handle, double* __retval)
{
    *__retval = UITouch::GetTimestamp(handle);
}

// private static Fuse.Controls.Native.iOS.UITouch.TouchPhase GetTouchPhase(ObjC.Object handle) :1056
void UITouch__GetTouchPhase_fn(::g::ObjC::Object* handle, int* __retval)
{
    *__retval = UITouch::GetTouchPhase(handle);
}

// public float2 LocationInView(ObjC.Object view) :1022
...
// private static void LocationInView(ObjC.Object handle, ObjC.Object viewHandle, Uno.IntPtr x, Uno.IntPtr y) :1081
...
// public Fuse.Controls.Native.iOS.UITouch.TouchPhase get_Phase() [instance] :1039
int UITouch::Phase()
{
    return UITouch::GetTouchPhase(_handle);
}

// public double get_Timestamp() [instance] :1034
double UITouch::Timestamp()
{
    return UITouch::GetTimestamp(_handle);
}

// private static bool Compare(ObjC.Object handle1, ObjC.Object handle2) [static] :1100
...
// private static double GetTimestamp(ObjC.Object handle) [static] :1092
...
// private static Fuse.Controls.Native.iOS.UITouch.TouchPhase GetTouchPhase(ObjC.Object handle) [static] :1056
...
// private static void LocationInView(ObjC.Object handle, ObjC.Object viewHandle, Uno.IntPtr x, Uno.IntPtr y) [static] :1081
...
// public UITouch New(ObjC.Object handle) [static] :1017
