...
// /Users/coder/Library/Application Support/Fusetools/Packages/Fuse.Scripting/0.47.7/$.uno
// ---------------------------------------------------------------------------------------
...
// public CodeModule(Uno.IO.Bundle bundle, string fileName, string code, int lineNumberOffset) :261
...
// public CodeModule New(Uno.IO.Bundle bundle, string fileName, string code, int lineNumberOffset) :261
...
// public CodeModule(Uno.IO.Bundle bundle, string fileName, string code, int lineNumberOffset) [instance] :261
...
// public CodeModule New(Uno.IO.Bundle bundle, string fileName, string code, int lineNumberOffset) [static] :261
...
static void Context_build(uType* type)
{
    ...
    ::STRINGS[7] = uString::Const("(function() { return new Object; })");
    ::STRINGS[8] = uString::Const("Object.create");
    ...
    ::STRINGS[12] = uString::Const(" enumerable: e, configurable: c }); })");
    ...
    ::STRINGS[14] = uString::Const("JSON.parse");
    ...
    type->SetFields(0,
        ...
        ::TYPES[8/*Fuse.Scripting.Function*/], offsetof(::g::Fuse::Scripting::Context, _newError), 0,
    ...
    type->Reflection.SetFunctions(19,
        new uFunction("CallbackToFunction", NULL, (void*)Context__CallbackToFunction_fn, 0, false, ::TYPES[8/*Fuse.Scripting.Function*/], 1, ::g::Fuse::Scripting::Callback_typeof()),
        new uFunction("get_Dispatcher", NULL, (void*)Context__get_Dispatcher_fn, 0, false, ::TYPES[2/*Uno.Threading.IDispatcher*/], 0),
        ...
        new uFunction("NewArray", NULL, (void*)Context__NewArray_fn, 0, false, ::TYPES[11/*Fuse.Scripting.Array*/], 1, ::TYPES[9/*object[]*/]),
        new uFunction("NewError", NULL, (void*)Context__NewError_fn, 0, false, ::TYPES[12/*Fuse.Scripting.Object*/], 1, ::TYPES[9/*object[]*/]),
        new uFunction("NewObject", NULL, (void*)Context__NewObject_fn, 0, false, ::TYPES[12/*Fuse.Scripting.Object*/], 0),
        new uFunction("ObjectCreate", NULL, (void*)Context__ObjectCreate_fn, 0, false, ::TYPES[12/*Fuse.Scripting.Object*/], 1, ::TYPES[9/*object[]*/]),
        new uFunction("ObjectDefineProperty", NULL, (void*)Context__ObjectDefineProperty_fn, 0, false, uVoid_typeof(), 6, ::TYPES[12/*Fuse.Scripting.Object*/], ::g::Uno::String_typeof(), ::g::Fuse::Scripting::Callback_typeof(), ::g::Fuse::Scripting::Callback_typeof(), ::g::Uno::Bool_typeof(), ::g::Uno::Bool_typeof()),
        new uFunction("ObjectDefineProperty", NULL, (void*)Context__ObjectDefineProperty1_fn, 0, false, uVoid_typeof(), 5, ::TYPES[12/*Fuse.Scripting.Object*/], ::g::Uno::String_typeof(), uObject_typeof(), ::g::Uno::Bool_typeof(), ::g::Uno::Bool_typeof()),
        new uFunction("get_Observable", NULL, (void*)Context__get_Observable_fn, 0, false, ::TYPES[8/*Fuse.Scripting.Function*/], 0),
        ...
        new uFunction("get_ThreadWorker", NULL, (void*)Context__get_ThreadWorker_fn, 0, false, ::TYPES[10/*Fuse.Scripting.IThreadWorker*/], 0),
...
// public Fuse.Scripting.Object NewError(object[] args) :209
...
// public Fuse.Scripting.Object ObjectCreate(object[] args) :174
...
::g::Fuse::Scripting::Array* Context::NewArray(uArray* values)
{
    ...
    ::g::Fuse::Scripting::Array* a = uCast< ::g::Fuse::Scripting::Array*>(uPtr(_newArray)->Call(uArray::Init<uObject*>(::TYPES[9/*object[]*/], 1, uBox<int>(::TYPES[47/*int*/], uPtr(values)->Length()))), ::TYPES[11/*Fuse.Scripting.Array*/]);
...
// public Fuse.Scripting.Object NewError(object[] args) [instance] :209
::g::Fuse::Scripting::Object* Context::NewError(uArray* args)
{
    uStackFrame __("Fuse.Scripting.Context", "NewError(object[])");
    _newError = uAs< ::g::Fuse::Scripting::Function*>(uPtr(GlobalObject())->Item(::STRINGS[6/*"Error"*/]), ::TYPES[8/*Fuse.Scripting.Function*/]);
...
::g::Fuse::Scripting::Object* Context::NewObject()
{
    ...
    if (_newObject == NULL)
        _newObject = uCast< ::g::Fuse::Scripting::Function*>(Evaluate(::STRINGS[3/*"(Context)"*/], ::STRINGS[7/*"(function()...*/]), ::TYPES[8/*Fuse.Scripting.Function*/]);

    return uCast< ::g::Fuse::Scripting::Object*>(uPtr(_newObject)->Call(uArray::New(::TYPES[9/*object[]*/], 0)), ::TYPES[12/*Fuse.Scripting.Object*/]);
}

// public Fuse.Scripting.Object ObjectCreate(object[] args) [instance] :174
::g::Fuse::Scripting::Object* Context::ObjectCreate(uArray* args)
{
    uStackFrame __("Fuse.Scripting.Context", "ObjectCreate(object[])");
    ::g::Fuse::Scripting::Function* objectCreate = uAs< ::g::Fuse::Scripting::Function*>(Evaluate(::STRINGS[3/*"(Context)"*/], ::STRINGS[8/*"Object.create"*/]), ::TYPES[8/*Fuse.Scripting.Function*/]);
...
void Context::ObjectDefineProperty(::g::Fuse::Scripting::Object* obj, uString* name, uDelegate* getProperty, uDelegate* setProperty, bool enumerable, bool configurable)
{
    ...
    ::g::Fuse::Scripting::Function* func = uAs< ::g::Fuse::Scripting::Function*>(Evaluate(name, ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[9/*"(function(o...*/], ::g::Uno::Delegate::op_Inequality(setProperty, NULL) ? ::STRINGS[10/*" set: setCa...*/] : ::STRINGS[11/*""*/]), ::STRINGS[12/*" enumerable...*/])), ::TYPES[8/*Fuse.Scripting.Function*/]);
...
void Context::ObjectDefineProperty1(::g::Fuse::Scripting::Object* obj, uString* name, uObject* value, bool enumerable, bool configurable)
{
    ...
    ::g::Fuse::Scripting::Function* func = uAs< ::g::Fuse::Scripting::Function*>(Evaluate(name, ::STRINGS[13/*"(function(o...*/]), ::TYPES[8/*Fuse.Scripting.Function*/]);
...
uObject* Context::ParseJson(uString* json)
{
    ...
    if (_parseJson == NULL)
        _parseJson = uCast< ::g::Fuse::Scripting::Function*>(Evaluate(::STRINGS[3/*"(Context)"*/], ::STRINGS[14/*"JSON.parse"*/]), ::TYPES[8/*Fuse.Scripting.Function*/]);
...
{
    ::STRINGS[15] = uString::Const("Promise");
    ::TYPES[8] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[9] = uObject_typeof()->Array();
...
uObject* NativePromise__ContextClosure::CreatePromise(uArray* args)
{
    ...
    ::g::Fuse::Scripting::Function* promise = uCast< ::g::Fuse::Scripting::Function*>(uPtr(uPtr(_c)->GlobalObject())->Item(::STRINGS[15/*"Promise"*/]), ::TYPES[8/*Fuse.Scripting.Function*/]);
...
// public DoubleChangedArgs(double value) :334
void DoubleChangedArgs__ctor_2_fn(DoubleChangedArgs* __this, double* value)
{
    __this->ctor_2(*value);
}

// private void Fuse.Scripting.IScriptEvent.Serialize(Fuse.Scripting.IEventSerializer s) :338
void DoubleChangedArgs__FuseScriptingIScriptEventSerialize_fn(DoubleChangedArgs* __this, uObject* s)
{
    ...
    double ret2;
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(uPtr(s), ::TYPES[4/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[2/*"value"*/], (::g::Uno::UX::ValueChangedArgs__get_Value_fn(__this, &ret2), ret2));
}

// public DoubleChangedArgs New(double value) :334
void DoubleChangedArgs__New3_fn(double* value, DoubleChangedArgs** __retval)
{
    *__retval = DoubleChangedArgs::New3(*value);
}

// public DoubleChangedArgs(double value) [instance] :334
void DoubleChangedArgs::ctor_2(double value)
{
    ::g::Uno::UX::ValueChangedArgs__ctor_1_fn(this, uCRef(value));
}

// public DoubleChangedArgs New(double value) [static] :334
...
void NativeEventEmitterModule__EmitClosure::Emit(::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::Object* o)
{
    ...
    uPtr(o)->CallMethod(::STRINGS[16/*"emit"*/], _args);
}
...
{
    ::STRINGS[17] = uString::Const("Fuse.Reactive.JavaScript");
    ::STRINGS[18] = uString::Const("FuseJS/EventEmitter.js");
    ::STRINGS[19] = uString::Const("FuseJS/EventEmitter");
    ::STRINGS[20] = uString::Const("Unable to get a FuseJS/EventEmitter instance");
    ::TYPES[8] = ::g::Fuse::Scripting::Function_typeof();
    type->SetFields(0,
...
::g::Fuse::Scripting::Function* EventEmitterModule::GetConstructor(::g::Fuse::Scripting::Context* c)
{
    ...
    {
        ::g::Uno::IO::BundleFile* fileSource = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[17/*"Fuse.Reacti...*/]))->GetFile(::STRINGS[18/*"FuseJS/Even...*/]);
        uObject* exports = ::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(fileSource))->EvaluateExports(c, ::STRINGS[19/*"FuseJS/Even...*/]);
        EventEmitterModule::_instance_ = uAs< ::g::Fuse::Scripting::Function*>(exports, ::TYPES[8/*Fuse.Scripting.Function*/]);

        if (EventEmitterModule::_instance_ == NULL)
            U_THROW(::g::Uno::Exception::New2(::STRINGS[20/*"Unable to g...*/]));
    }
...
// public FuncClosure(Uno.Func<TArg, TArg1, TResult> method) :494
void JSCallback__FuncClosure2__ctor__fn(JSCallback__FuncClosure2* __this, uDelegate* method)
{
    __this->ctor_(method);
}

// public FuncClosure New(Uno.Func<TArg, TArg1, TResult> method) :494
...
// public FuncClosure New(Uno.Func<TArg, TArg1, TResult> method) [static] :494
...
static void JSCallback_build(uType* type)
{
    ...
    ::TYPES[20] = JSCallback__FuncClosure2_typeof();
    ::TYPES[21] = JSCallback__NumberConverter_typeof();
    ...
    type->MethodTypes[4]->SetPrecalc(
        ::TYPES[20/*Fuse.Scripting.JSCallback.FuncClosure`3*/]->MakeType(type->MethodTypes[4]->U(0), type->MethodTypes[4]->U(1), type->MethodTypes[4]->U(2), NULL));
    type->MethodTypes[5]->SetPrecalc(
        ::TYPES[21/*Fuse.Scripting.JSCallback.NumberConverter*/]->MakeMethod(1/*TryConvert<T>*/, type->MethodTypes[5]->U(0), NULL));
    type->Reflection.SetFunctions(6,
        new uFunction("FromAction", NULL, (void*)JSCallback__FromAction_fn, 0, true, ::TYPES[13/*Fuse.Scripting.Callback*/], 1, ::g::Uno::Action_typeof()),
        new uFunction("FromAction`1", type->MethodTypes[0], (void*)JSCallback__FromAction1_fn, 0, true, ::TYPES[13/*Fuse.Scripting.Callback*/], 1, ::g::Uno::Action1_typeof()->MakeType(type->MethodTypes[0]->U(0), NULL)),
        new uFunction("FromAction`2", type->MethodTypes[1], (void*)JSCallback__FromAction2_fn, 0, true, ::TYPES[13/*Fuse.Scripting.Callback*/], 1, ::g::Uno::Action2_typeof()->MakeType(type->MethodTypes[1]->U(0), type->MethodTypes[1]->U(1), NULL)),
        new uFunction("FromFunc`1", type->MethodTypes[2], (void*)JSCallback__FromFunc_fn, 0, true, ::TYPES[13/*Fuse.Scripting.Callback*/], 1, ::g::Uno::Func_typeof()->MakeType(type->MethodTypes[2]->U(0), NULL)),
        new uFunction("FromFunc`2", type->MethodTypes[3], (void*)JSCallback__FromFunc1_fn, 0, true, ::TYPES[13/*Fuse.Scripting.Callback*/], 1, ::g::Uno::Func1_typeof()->MakeType(type->MethodTypes[3]->U(0), type->MethodTypes[3]->U(1), NULL)),
        new uFunction("FromFunc`3", type->MethodTypes[4], (void*)JSCallback__FromFunc2_fn, 0, true, ::TYPES[13/*Fuse.Scripting.Callback*/], 1, ::g::Uno::Func2_typeof()->MakeType(type->MethodTypes[4]->U(0), type->MethodTypes[4]->U(1), type->MethodTypes[4]->U(2), NULL)));
}
...
// public static Fuse.Scripting.Callback FromFunc<T1, T2, TResult>(Uno.Func<T1, T2, TResult> func) :390
...
// public static Fuse.Scripting.Callback FromFunc<T1, T2, TResult>(Uno.Func<T1, T2, TResult> func) [static] :390
uDelegate* JSCallback::FromFunc2(uType* __type, uDelegate* func)
{
    ...
    return uDelegate::New(::TYPES[13/*Fuse.Scripting.Callback*/], (void*)JSCallback__FuncClosure2__Run_fn, (JSCallback__FuncClosure2*)JSCallback__FuncClosure2::New1(__types[0], func));
}
// }
...
{
    ::STRINGS[21] = uString::Const("(Object Freeze)");
    ::STRINGS[22] = uString::Const("Object.freeze");
    ::STRINGS[23] = uString::Const("Property '");
    ::STRINGS[24] = uString::Const("' does not exist on object");
    ::TYPES[8] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[9] = uObject_typeof()->Array();
    ::TYPES[22] = ::g::Fuse::Marshal_typeof();
    type->MethodTypes[0]->SetPrecalc(
        ::TYPES[22/*Fuse.Marshal*/]->MakeMethod(0/*ToType<T>*/, type->MethodTypes[0]->U(0), NULL));
    type->MethodTypes[1]->SetPrecalc(
        ::TYPES[22/*Fuse.Marshal*/]->MakeMethod(0/*ToType<T>*/, type->MethodTypes[1]->U(0), NULL));
    type->MethodTypes[2]->SetPrecalc(
        ::TYPES[22/*Fuse.Marshal*/]->MakeMethod(0/*ToType<T>*/, type->MethodTypes[2]->U(0), NULL));
    type->MethodTypes[3]->SetPrecalc(
        ::TYPES[22/*Fuse.Marshal*/]->MakeMethod(0/*ToType<T>*/, type->MethodTypes[3]->U(0), NULL));
    type->Reflection.SetFunctions(5,
        ...
        new uFunction("Value`1", type->MethodTypes[1], (void*)JSObjectUtils__Value1_fn, 0, true, type->MethodTypes[1]->U(0), 2, ::TYPES[9/*object[]*/], ::g::Uno::Int_typeof()),
        ...
        new uFunction("ValueOrDefault`1", type->MethodTypes[3], (void*)JSObjectUtils__ValueOrDefault1_fn, 0, true, type->MethodTypes[3]->U(0), 3, ::TYPES[9/*object[]*/], ::g::Uno::Int_typeof(), type->MethodTypes[3]->U(0)));
}
...
// public static void Freeze(Fuse.Scripting.Object ob, Fuse.Scripting.Context c) :629
void JSObjectUtils__Freeze_fn(::g::Fuse::Scripting::Object* ob, ::g::Fuse::Scripting::Context* c)
{
    JSObjectUtils::Freeze(ob, c);
}

// public static T Value<T>(Fuse.Scripting.Object obj, string name) :617
void JSObjectUtils__Value_fn(uType* __type, ::g::Fuse::Scripting::Object* obj, uString* name, uTRef __retval)
{
    ...
    if (v == NULL)
        U_THROW(::g::Uno::ArgumentException::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[23/*"Property '"*/], name), ::STRINGS[24/*"' does not ...*/])));

    return __retval.Store((::g::Fuse::Marshal__ToType_fn(__types[1], v, &ret1), ret1)), void();
}

// public static T Value<T>(object[] args, int index) :624
void JSObjectUtils__Value1_fn(uType* __type, uArray* args, int* index, uTRef __retval)
{
    ...
    uT ret2(__types[0], U_ALLOCA(__types[0]->ValueSize));
    int index_ = *index;
    return __retval.Store((::g::Fuse::Marshal__ToType_fn(__types[1], uPtr(args)->Strong<uObject*>(index_), &ret2), ret2)), void();
}

// public static T ValueOrDefault<T>(Fuse.Scripting.Object obj, string name, T defaultValue) :604
void JSObjectUtils__ValueOrDefault_fn(uType* __type, ::g::Fuse::Scripting::Object* obj, uString* name, void* defaultValue, uTRef __retval)
{
    ...
    return __retval.Store((::g::Fuse::Marshal__ToType_fn(__types[1], v, &ret3), ret3)), void();
}
...
// public static void Freeze(Fuse.Scripting.Object ob, Fuse.Scripting.Context c) [static] :629
void JSObjectUtils::Freeze(::g::Fuse::Scripting::Object* ob, ::g::Fuse::Scripting::Context* c)
{
    ...
    ::g::Fuse::Scripting::Function* freeze = uCast< ::g::Fuse::Scripting::Function*>(uPtr(c)->Evaluate(::STRINGS[21/*"(Object Fre...*/], ::STRINGS[22/*"Object.freeze"*/]), ::TYPES[8/*Fuse.Scripting.Function*/]);
    uPtr(freeze)->Call(uArray::Init<uObject*>(::TYPES[9/*object[]*/], 1, ob));
}
// }
...
{
    ::STRINGS[25] = uString::Const("exports");
    ::STRINGS[26] = uString::Const("disposed");
    ::STRINGS[27] = uString::Const("id");
    ::TYPES[9] = uObject_typeof()->Array();
    ::TYPES[23] = ::g::Fuse::Scripting::ScriptException_typeof();
    ::TYPES[24] = ::g::Uno::EventHandler_typeof();
    type->SetInterfaces(
        ::g::Uno::IDisposable_typeof(), offsetof(Module_type, interface0));
    type->SetFields(0,
        ::TYPES[24/*Uno.EventHandler*/], offsetof(::g::Fuse::Scripting::Module, _evaluated), 0,
    ...
    type->Reflection.SetFunctions(7,
        ...
        new uFunction("add_Evaluated", NULL, (void*)Module__add_Evaluated_fn, 0, false, uVoid_typeof(), 1, ::TYPES[24/*Uno.EventHandler*/]),
        new uFunction("remove_Evaluated", NULL, (void*)Module__remove_Evaluated_fn, 0, false, uVoid_typeof(), 1, ::TYPES[24/*Uno.EventHandler*/]),
...
// public void add_Evaluated(Uno.EventHandler value) :685
void Module__add_Evaluated_fn(Module* __this, uDelegate* value)
{
    __this->add_Evaluated(value);
}

// public void remove_Evaluated(Uno.EventHandler value) :692
...
::g::Fuse::Scripting::ModuleResult* Module::Evaluate1(::g::Fuse::Scripting::Context* c, uString* id)
{
    ...
    uPtr(module)->Item(::STRINGS[25/*"exports"*/], CreateExportsObject(c));
    module->Item(::STRINGS[26/*"disposed"*/], c->NewArray(uArray::New(::TYPES[9/*object[]*/], 0)));
    ...
    {
        if (uIs(__t.Exception, ::TYPES[23/*Fuse.Scripting.ScriptException*/]))
        {
    ...
    if (::g::Uno::String::op_Inequality(id, NULL))
        uPtr(module)->Item(::STRINGS[27/*"id"*/], id);

    return result;
}

// public void add_Evaluated(Uno.EventHandler value) [instance] :685
void Module::add_Evaluated(uDelegate* value)
{
    ...
    if (_isEvaluated)
        ...
        _evaluated = uCast<uDelegate*>(::g::Uno::Delegate::Combine(_evaluated, value), ::TYPES[24/*Uno.EventHandler*/]);
}

// public void remove_Evaluated(Uno.EventHandler value) [instance] :692
void Module::remove_Evaluated(uDelegate* value)
{
    uStackFrame __("Fuse.Scripting.Module", "remove_Evaluated(Uno.EventHandler)");
    _evaluated = uCast<uDelegate*>(::g::Uno::Delegate::Remove(_evaluated, value), ::TYPES[24/*Uno.EventHandler*/]);
}
...
uObject* Module::EvaluateExports(::g::Fuse::Scripting::Context* c, uString* id)
{
    ...
    uObject* r = uPtr(uPtr(Evaluate1(c, id))->Object)->Item(::STRINGS[25/*"exports"*/]);
    return r;
}
...
{
    ::STRINGS[26] = uString::Const("disposed");
    ::STRINGS[28] = uString::Const("(unknown module)");
    ::STRINGS[25] = uString::Const("exports");
    ::TYPES[25] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Action_typeof(), NULL);
    ::TYPES[26] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::String_typeof(), NULL);
    ::TYPES[27] = ::g::Uno::EventHandler1_typeof()->MakeType(::g::Uno::EventArgs_typeof(), NULL);
    ::TYPES[3] = ::g::Uno::Action_typeof();
    ::TYPES[11] = ::g::Fuse::Scripting::Array_typeof();
    ::TYPES[8] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[9] = uObject_typeof()->Array();
    type->SetFields(0,
        ...
        ::TYPES[25/*Uno.Collections.List<Uno.Action>*/], offsetof(::g::Fuse::Scripting::ModuleResult, _invalidateCallbacks), 0,
    ...
    type->Reflection.SetFields(4,
        ...
        new uField("Object", 6));
    type->Reflection.SetFunctions(6,
        new uFunction("AddDependency", NULL, (void*)ModuleResult__AddDependency_fn, 0, false, uVoid_typeof(), 1, ::TYPES[3/*Uno.Action*/]),
...
void ModuleResult__ToString_fn(ModuleResult* __this, uString** __retval)
{
    ...
    return *__retval = ::STRINGS[28/*"(unknown mo...*/], void();
}
...
void ModuleResult::ctor_(::g::Fuse::Scripting::Context* context, uString* id, ::g::Fuse::Scripting::Module* mod, ::g::Fuse::Scripting::Object* obj)
{
    ...
    _invalidateCallbacks = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[25/*Uno.Collections.List<Uno.Action>*/]));
    Context = context;
    Module = mod;
    Object = obj;
    Id = id;
    ...
    if (::g::Uno::String::op_Inequality(Id, NULL))
    {
        ...
        ::g::Uno::UX::Resource::AddGlobalKeyListener(uDelegate::New(::TYPES[26/*Uno.Action<string>*/], (void*)ModuleResult__OnGlobalKeyChanged_fn, this));
    }

    if (uPtr(Module)->GetFile() != NULL)
    {
        uPtr(uPtr(Module)->GetFile())->add_DataChanged(uDelegate::New(::TYPES[27/*Uno.EventHandler<Uno.EventArgs>*/], (void*)ModuleResult__OnDataChanged_fn, this));
        _fileListening = true;
    }
}
...
void ModuleResult::Dispose()
{
    ...
    if (_fileListening)
    {
        uPtr(uPtr(Module)->GetFile())->remove_DataChanged(uDelegate::New(::TYPES[27/*Uno.EventHandler<Uno.EventArgs>*/], (void*)ModuleResult__OnDataChanged_fn, this));
        _fileListening = false;
    }

    if (_globalKeyListening)
    {
        ::g::Uno::UX::Resource::RemoveGlobalKeyListener(uDelegate::New(::TYPES[26/*Uno.Action<string>*/], (void*)ModuleResult__OnGlobalKeyChanged_fn, this));
...
void ModuleResult::OnDisposed()
{
    ...
    if (uPtr(Object)->ContainsKey(::STRINGS[26/*"disposed"*/]))
    {
        ::g::Fuse::Scripting::Array* disposed = uAs< ::g::Fuse::Scripting::Array*>(uPtr(Object)->Item(::STRINGS[26/*"disposed"*/]), ::TYPES[11/*Fuse.Scripting.Array*/]);
...
static void NativeEvent_build(uType* type)
{
    ...
    ::STRINGS[30] = uString::Const("/Users/coder/Library/Application Support/Fusetools/Packages/Fuse.Scripting/0.47.7/$.uno");
    ...
    type->SetFields(8,
        ::TYPES[28/*Uno.Collections.Queue<object[]>*/], offsetof(::g::Fuse::Scripting::NativeEvent, _eventArgsQueue), 0,
    ...
    type->Reflection.SetFunctions(2,
        ...
        new uFunction("RaiseAsync", NULL, (void*)NativeEvent__RaiseAsync_fn, 0, false, uVoid_typeof(), 1, ::TYPES[9/*object[]*/]));
}
...
// public void RaiseAsync(object[] args) :889
...
{
    ctor_1(name);
    _eventArgsQueue = ((::g::Uno::Collections::Queue*)::g::Uno::Collections::Queue::New1(::TYPES[28/*Uno.Collections.Queue<object[]>*/]));
...
void NativeEvent::DispatchQueue()
{
    ...
    while ((uPtr(_eventArgsQueue)->Count() > 0) && (_jsFunction != NULL))
        ::g::Uno::Threading::IDispatcherExtensions__Invoke11_fn(::TYPES[29/*Uno.Threading.IDispatcherExtensions.Invoke1<object[], object>*/], uPtr(Context())->Dispatcher(), uDelegate::New(::TYPES[30/*Uno.Func<object[], object>*/], uPtr(_jsFunction), offsetof(::g::Fuse::Scripting::Function_type, fp_Call)), (::g::Uno::Collections::Queue__Dequeue_fn(uPtr(_eventArgsQueue), &ret2), ret2));
}

// public void RaiseAsync(object[] args) [instance] :889
...
uObject* NativeEvent::RaiseSync(uArray* args)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(Context() != NULL, ::STRINGS[29/*"this.Contex...*/], ::STRINGS[30/*"/Users/code...*/], 899, uArray::New(::TYPES[9/*object[]*/], 0));

    if (_jsFunction != NULL)
        ::g::Uno::Threading::IDispatcherExtensions__Invoke11_fn(::TYPES[29/*Uno.Threading.IDispatcherExtensions.Invoke1<object[], object>*/], uPtr(Context())->Dispatcher(), uDelegate::New(::TYPES[30/*Uno.Func<object[], object>*/], uPtr(_jsFunction), offsetof(::g::Fuse::Scripting::Function_type, fp_Call)), args);
...
{
    ::STRINGS[31] = uString::Const("removeAllListeners");
    ::TYPES[31] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Tuple2_typeof()->MakeType(uObject_typeof(), ::g::Fuse::Scripting::Callback_typeof(), NULL), NULL);
    ::TYPES[32] = ::g::Uno::Collections::Queue_typeof()->MakeType(::g::Uno::Action2_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), ::g::Fuse::Scripting::Object_typeof(), NULL), NULL);
    ::TYPES[24] = ::g::Uno::EventHandler_typeof();
    ::TYPES[3] = ::g::Uno::Action_typeof();
    ::TYPES[33] = ::g::Uno::Threading::IDispatcherExtensions_typeof()->MakeMethod(2/*Invoke2<Fuse.Scripting.Context, Fuse.Scripting.Object>*/, ::g::Fuse::Scripting::Context_typeof(), ::g::Fuse::Scripting::Object_typeof(), NULL);
    ::TYPES[34] = ::g::Uno::Action2_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), ::g::Fuse::Scripting::Object_typeof(), NULL);
    ::TYPES[35] = ::g::Uno::Tuple_typeof()->MakeMethod(0/*Create<object, Fuse.Scripting.Callback>*/, uObject_typeof(), ::g::Fuse::Scripting::Callback_typeof(), NULL);
    ::TYPES[13] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[2] = ::g::Uno::Threading::IDispatcher_typeof();
    ::TYPES[9] = uObject_typeof()->Array();
    ::TYPES[36] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Uno::Tuple2_typeof()->MakeType(uObject_typeof(), ::TYPES[13/*Fuse.Scripting.Callback*/], NULL), NULL);
    type->SetInterfaces(
    ...
    type->SetFields(4,
        ...
        ::TYPES[31/*Uno.Collections.List<Uno.Tuple<object, Fuse.Scripting.Callback>>*/], offsetof(::g::Fuse::Scripting::NativeEventEmitterModule, _listeningCallbacks), 0,
        uObject_typeof(), offsetof(::g::Fuse::Scripting::NativeEventEmitterModule, _mutex), 0,
        ::TYPES[32/*Uno.Collections.Queue<Uno.Action<Fuse.Scripting.Context, Fuse.Scripting.Object>>*/], offsetof(::g::Fuse::Scripting::NativeEventEmitterModule, _queuedEvents), 0,
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)NativeEventEmitterModule__New2_fn, 0, true, type, 2, ::g::Uno::Bool_typeof(), ::TYPES[9/*object[]*/]));
}
...
// public NativeEventEmitterModule New(bool queueEventsBeforeInit, object[] eventNames) :935
...
void NativeEventEmitterModule::ctor_2(bool queueEventsBeforeInit, uArray* eventNames)
{
    ...
    _listeningCallbacks = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[31/*Uno.Collections.List<Uno.Tuple<object, Fuse.Scripting.Callback>>*/]));
    _mutex = ::g::Uno::Object::New();
    _queuedEvents = ((::g::Uno::Collections::Queue*)::g::Uno::Collections::Queue::New1(::TYPES[32/*Uno.Collections.Queue<Uno.Action<Fuse.Scripting.Context, Fuse.Scripting.Object>>*/]));
    ctor_1();
    _queueEventsBeforeInit = queueEventsBeforeInit;
    _eventNames = eventNames;
    add_Reset(uDelegate::New(::TYPES[24/*Uno.EventHandler*/], (void*)NativeEventEmitterModule__ResetListeners_fn, this));
}
...
void NativeEventEmitterModule::Dispatch(uDelegate* action, bool alwaysQueueEventBeforeInit)
{
    ...
    ::g::Uno::Threading::IDispatcherExtensions__Invoke2_fn(::TYPES[33/*Uno.Threading.IDispatcherExtensions.Invoke2<Fuse.Scripting.Context, Fuse.Scripting.Object>*/], uPtr(_context)->Dispatcher(), action, _context, _this);
}
...
void NativeEventEmitterModule::Emit(uArray* args)
{
    ...
    Dispatch(uDelegate::New(::TYPES[34/*Uno.Action<Fuse.Scripting.Context, Fuse.Scripting.Object>*/], (void*)NativeEventEmitterModule__EmitClosure__Emit_fn, NativeEventEmitterModule__EmitClosure::New1(args)), false);
}
...
void NativeEventEmitterModule::On(uObject* eventName, uDelegate* listener)
{
...

    {
        ...
        const uFinally<decltype(__finally_fun)> __f(__finally_fun);
        ::g::Uno::Collections::List__Add_fn(uPtr(_listeningCallbacks), (::g::Uno::Tuple__Create1_fn(::TYPES[35/*Uno.Tuple.Create<object, Fuse.Scripting.Callback>*/], eventName, listener, &ret4), ret4));
    }

    Dispatch(uDelegate::New(::TYPES[34/*Uno.Action<Fuse.Scripting.Context, Fuse.Scripting.Object>*/], (void*)NativeEventEmitterModule__OnClosure__On_fn, NativeEventEmitterModule__OnClosure::New1(eventName, listener)), true);
}
...
void NativeEventEmitterModule::ResetListenersJS()
{
    ...
    uObject* ret7;
    uDelegate* ret8;
    uPtr(_this)->CallMethod(::STRINGS[31/*"removeAllLi...*/], uArray::New(::TYPES[9/*object[]*/], 0));
    ::g::Uno::Threading::Monitor::Enter(_mutex);

    {
        ...
        for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Uno::Tuple2*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(_listeningCallbacks), &ret6), ret6); enum1.MoveNext(::TYPES[36/*Uno.Collections.List<Uno.Tuple<object, Fuse.Scripting.Callback>>.Enumerator*/]); )
        {
            ::g::Uno::Tuple2* l = enum1.Current(::TYPES[36/*Uno.Collections.List<Uno.Tuple<object, Fuse.Scripting.Callback>>.Enumerator*/]);
            Dispatch(uDelegate::New(::TYPES[34/*Uno.Action<Fuse.Scripting.Context, Fuse.Scripting.Object>*/], (void*)NativeEventEmitterModule__OnClosure__On_fn, NativeEventEmitterModule__OnClosure::New1((::g::Uno::Tuple2__get_Item1_fn(uPtr(l), &ret7), ret7), (::g::Uno::Tuple2__get_Item2_fn(uPtr(l), &ret8), ret8))), true);
        }
    }
...
// public NativeEventEmitterModule New(bool queueEventsBeforeInit, object[] eventNames) [static] :935
...
static void NativeModule_build(uType* type)
{
    ...
    ::STRINGS[25] = uString::Const("exports");
    ::TYPES[37] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Scripting::NativeMember_typeof(), NULL);
    ::TYPES[12] = ::g::Fuse::Scripting::Object_typeof();
    ::TYPES[38] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Scripting::NativeMember_typeof(), NULL);
    ::TYPES[24] = ::g::Uno::EventHandler_typeof();
    type->SetInterfaces(
    ...
    type->SetFields(2,
        ::TYPES[37/*Uno.Collections.List<Fuse.Scripting.NativeMember>*/], offsetof(::g::Fuse::Scripting::NativeModule, _members), 0,
        ::TYPES[24/*Uno.EventHandler*/], offsetof(::g::Fuse::Scripting::NativeModule, Reset1), 0);
    type->Reflection.SetFunctions(3,
        new uFunction(".ctor", NULL, (void*)NativeModule__New1_fn, 0, true, type, 0),
        new uFunction("add_Reset", NULL, (void*)NativeModule__add_Reset_fn, 0, false, uVoid_typeof(), 1, ::TYPES[24/*Uno.EventHandler*/]),
        new uFunction("remove_Reset", NULL, (void*)NativeModule__remove_Reset_fn, 0, false, uVoid_typeof(), 1, ::TYPES[24/*Uno.EventHandler*/]));
}
...
void NativeModule__Evaluate_fn(NativeModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result)
{
    ...
    if (module != NULL)
    {
        ::g::Fuse::Scripting::Object* obj = uAs< ::g::Fuse::Scripting::Object*>(uPtr(module)->Item(::STRINGS[25/*"exports"*/]), ::TYPES[12/*Fuse.Scripting.Object*/]);

        if (obj != NULL)

            for (::g::Uno::Collections::List__Enumerator<uStrong< ::g::Fuse::Scripting::NativeMember*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(__this->_members), &ret3), ret3); enum1.MoveNext(::TYPES[38/*Uno.Collections.List<Fuse.Scripting.NativeMember>.Enumerator*/]); )
            {
                ::g::Fuse::Scripting::NativeMember* m = enum1.Current(::TYPES[38/*Uno.Collections.List<Fuse.Scripting.NativeMember>.Enumerator*/]);
                uPtr(m)->Create(obj, c);
            }
    }
}
...
// public generated NativeModule New() :1223
...
{
    _members = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[37/*Uno.Collections.List<Fuse.Scripting.NativeMember>*/]));
    ctor_();
}
...
void NativeModule::add_Reset(uDelegate* value)
{
    ...
    Reset1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Reset1, value), ::TYPES[24/*Uno.EventHandler*/]);
}
...
void NativeModule::remove_Reset(uDelegate* value)
{
    ...
    Reset1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Reset1, value), ::TYPES[24/*Uno.EventHandler*/]);
}

// public generated NativeModule New() [static] :1223
...
{
    ::TYPES[39] = ::g::Fuse::Scripting::FutureFactory_typeof();
    ::TYPES[13] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[40] = NativePromise__ContextClosure_typeof();
    ::TYPES[41] = ::g::Uno::Threading::Promise_typeof();
    ::TYPES[42] = ::g::Uno::Threading::ThreadStart_typeof();
    ::TYPES[43] = ::g::Fuse::Scripting::FactoryClosure_typeof();
    type->SetPrecalc(
    ...
    type->SetFields(3,
        ...
        ::TYPES[39/*Fuse.Scripting.FutureFactory`1*/]->MakeType(type->T(0), NULL), offsetof(::g::Fuse::Scripting::NativePromise, _futureFactory), 0,
    ...
    type->Reflection.SetFunctions(2,
        new uFunction(".ctor", type, (void*)NativePromise__New1_fn, 0, true, type, 3, ::g::Uno::String_typeof(), ::TYPES[39/*Fuse.Scripting.FutureFactory`1*/]->MakeType(type->T(0), NULL), ::g::Fuse::Scripting::ResultConverter_typeof()->MakeType(type->T(0), type->T(1), NULL)),
...
::g::Uno::Threading::Future1* NativePromise::Factory(uArray* args)
{
    ...
    ::g::Uno::Threading::Thread::New2(uDelegate::New(::TYPES[42/*Uno.Threading.ThreadStart*/], (void*)::g::Fuse::Scripting::FactoryClosure__Run_fn, (::g::Fuse::Scripting::FactoryClosure*)::g::Fuse::Scripting::FactoryClosure::New1(__types[1], _func, args, future)))->Start();
    return future;
}
...
{
    ::TYPES[13] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[44] = ::g::Uno::Func_typeof();
    ::TYPES[45] = ::g::Uno::Action1_typeof();
    type->SetPrecalc(
        type->T(1),
        type->T(0),
    ...
    type->SetFields(3,
        ::TYPES[44/*Uno.Func`1*/]->MakeType(type->T(0), NULL), offsetof(::g::Fuse::Scripting::NativeProperty, _getHandler), 0,
        ::g::Uno::Bool_typeof(), offsetof(::g::Fuse::Scripting::NativeProperty, _isReadonly), 0,
        type->T(1), (uintptr_t)0, uFieldFlagsConstrained,
        ::TYPES[45/*Uno.Action`1*/]->MakeType(type->T(1), NULL), offsetof(::g::Fuse::Scripting::NativeProperty, _setHandler), 0,
    ...
    type->Reflection.SetFunctions(3,
        ...
        new uFunction(".ctor", type, (void*)NativeProperty__New2_fn, 0, true, type, 4, ::g::Uno::String_typeof(), ::TYPES[44/*Uno.Func`1*/]->MakeType(type->T(0), NULL), ::TYPES[45/*Uno.Action`1*/]->MakeType(type->T(1), NULL), ::g::Fuse::Scripting::ValueConverter_typeof()->MakeType(type->T(0), type->T(1), NULL)),
...
// public NativeProperty New(string name) :1433
...
// public NativeProperty New(string name) [static] :1433
...
{
    ::TYPES[1] = ::g::Uno::Type_typeof();
    ::TYPES[46] = ::g::Uno::Short_typeof();
    ::TYPES[47] = ::g::Uno::Int_typeof();
    ::TYPES[48] = ::g::Uno::Long_typeof();
    ::TYPES[49] = ::g::Uno::Float_typeof();
    ::TYPES[50] = ::g::Uno::Double_typeof();
    ::TYPES[15] = ::g::Uno::Exception_typeof();
    type->MethodTypes[1]->SetPrecalc(
...
{
    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[46/*short*/]))
        return uBox<int16_t>(::TYPES[46/*short*/], (int16_t)value);

    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[47/*int*/]))
        return uBox<int>(::TYPES[47/*int*/], (int)value);

    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[48/*long*/]))
        return uBox<int64_t>(::TYPES[48/*long*/], (int64_t)value);

    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[49/*float*/]))
        return uBox(::TYPES[49/*float*/], (float)value);

    return uBox(::TYPES[50/*double*/], value);
}
...
uObject* JSCallback__NumberConverter::Convert1(float value, uType* targetType)
{
    ...
    if (::g::Uno::Type::op_Equality(targetType, ::TYPES[50/*double*/]))
        return uBox(::TYPES[50/*double*/], (double)value);

    return uBox(::TYPES[49/*float*/], value);
}
...
uObject* JSCallback__NumberConverter::Convert2(int value, uType* targetType)
{
    ...
    return uBox<int>(::TYPES[47/*int*/], value);
}
...
uObject* JSCallback__NumberConverter::Convert3(int64_t value, uType* targetType)
{
    ...
    return uBox<int64_t>(::TYPES[48/*long*/], value);
}
...
uObject* JSCallback__NumberConverter::Convert4(int16_t value, uType* targetType)
{
    ...
    return uBox<int16_t>(::TYPES[46/*short*/], value);
}
...
uObject* JSCallback__NumberConverter::Convert5(uType* targetType, uObject* value)
{
    ...
    if (uIs(value, ::TYPES[46/*short*/]))
        return JSCallback__NumberConverter::Convert4(uUnbox<int16_t>(::TYPES[46/*short*/], value), targetType);

    if (uIs(value, ::TYPES[47/*int*/]))
        return JSCallback__NumberConverter::Convert2(uUnbox<int>(::TYPES[47/*int*/], value), targetType);

    if (uIs(value, ::TYPES[48/*long*/]))
        return JSCallback__NumberConverter::Convert3(uUnbox<int64_t>(::TYPES[48/*long*/], value), targetType);

    if (uIs(value, ::TYPES[49/*float*/]))
        return JSCallback__NumberConverter::Convert1(uUnbox<float>(::TYPES[49/*float*/], value), targetType);

    if (uIs(value, ::TYPES[50/*double*/]))
        return JSCallback__NumberConverter::Convert(uUnbox<double>(::TYPES[50/*double*/], value), targetType);
...
void NativeEventEmitterModule__OnClosure::On(::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::Object* o)
{
    ...
    uPtr(o)->CallMethod(::STRINGS[33/*"on"*/], uArray::Init<uObject*>(::TYPES[9/*object[]*/], 2, (uObject*)_eventName, (uDelegate*)_listener));
}
...
static void NativePromise__PromiseClosure_build(uType* type)
{
    ...
    ::TYPES[8] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[45] = ::g::Uno::Action1_typeof();
    ::TYPES[51] = ::TYPES[45/*Uno.Action`1*/]->MakeType(::g::Uno::Exception_typeof(), NULL);
    type->SetPrecalc(
        type->T(1),
...
uObject* NativePromise__PromiseClosure::Run(uArray* args)
{
    ...
    uPtr(_promise)->Then1(uDelegate::New(__types[0], (void*)NativePromise__PromiseClosure__Resolve_fn, this), uDelegate::New(::TYPES[51/*Uno.Action<Uno.Exception>*/], (void*)NativePromise__PromiseClosure__Reject_fn, this));
    return NULL;
}
...
static void ScriptModule__RequireContext_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::TYPES[52/*string*/], (uintptr_t)&::g::Fuse::Scripting::ScriptModule__RequireContext::_lastErrorPath_, uFieldFlagsStatic);
}
...
uObject* ScriptModule__RequireContext::Require(uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
        U_THROW(::g::Fuse::Scripting::Error::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[34/*"require(): ...*/], uBox<int>(::TYPES[47/*int*/], uPtr(args)->Length())), ::STRINGS[35/*" provided"*/])));

    uString* id = uAs<uString*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[52/*string*/]);
...
uObject* ScriptModule__RequireContext::Require1(uString* id)
{
    ...
    if (module == NULL)
    {
        ...
        if (module->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[38/*"JavaScript ...*/], path), ::STRINGS[39/*" was fixed!"*/]), this, ::STRINGS[30/*"/Users/code...*/], 1854, ::STRINGS[40/*"Require"*/]);
        ...
        else
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[38/*"JavaScript ...*/], path), ::STRINGS[41/*" line "*/]), uBox<int>(::TYPES[47/*int*/], uPtr(e)->LineNumber())), ::STRINGS[42/*". "*/]), uPtr(e)->ErrorMessage()), this, ::STRINGS[30/*"/Users/code...*/], 1864, ::STRINGS[40/*"Require"*/], NULL);
...
{
    ScriptClass::_unoTypeToScriptClass_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[53/*Uno.Collections.Dictionary<Uno.Type, Fuse.Scripting.ScriptClass>*/]));
}

static void ScriptClass_build(uType* type)
{
    ::TYPES[53] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Type_typeof(), type, NULL);
    type->SetFields(0,
        ...
        ::TYPES[53/*Uno.Collections.Dictionary<Uno.Type, Fuse.Scripting.ScriptClass>*/], (uintptr_t)&::g::Fuse::Scripting::ScriptClass::_unoTypeToScriptClass_, uFieldFlagsStatic);
    type->Reflection.SetFunctions(5,
...
// public generated ScriptEventArgs() [instance] :312
void ScriptEventArgs::ctor_1()
{
    ctor_();
}

// public void Serialize(Fuse.Scripting.IEventSerializer s) [instance] :317
void ScriptEventArgs::Serialize(uObject* s)
{
}

// public generated ScriptEventArgs New() [static] :312
...
// public static new Fuse.Scripting.ScriptEventArgs get_Empty() [static] :315
...
static void ScriptException_build(uType* type)
{
    ...
    ::STRINGS[44] = uString::Const("Error message: ");
    ::STRINGS[45] = uString::Const("File name: ");
    ::STRINGS[46] = uString::Const("Line number: ");
    ::STRINGS[47] = uString::Const("Source line: ");
    ::STRINGS[48] = uString::Const("JS stack trace: ");
    ::TYPES[47] = ::g::Uno::Int_typeof();
    type->SetFields(3,
        ...
        ::TYPES[47/*int*/], offsetof(::g::Fuse::Scripting::ScriptException, _LineNumber), 0,
    ...
    type->Reflection.SetFunctions(7,
        ...
        new uFunction("get_LineNumber", NULL, (void*)ScriptException__get_LineNumber_fn, 0, false, ::TYPES[47/*int*/], 0),
        new uFunction("get_Name", NULL, (void*)ScriptException__get_Name_fn, 0, false, ::g::Uno::String_typeof(), 0),
        new uFunction(".ctor", NULL, (void*)ScriptException__New4_fn, 0, true, type, 6, ::g::Uno::String_typeof(), ::g::Uno::String_typeof(), ::g::Uno::String_typeof(), ::TYPES[47/*int*/], ::g::Uno::String_typeof(), ::g::Uno::String_typeof()),
...
void ScriptException__get_Message_fn(ScriptException* __this, uString** __retval)
{
    ...
    {
        uPtr(stringBuilder)->Append2(::STRINGS[44/*"Error messa...*/]);
        stringBuilder->AppendLine(__this->ErrorMessage());
    }

    if (!::g::Uno::String::IsNullOrEmpty(__this->FileName()))
    {
        uPtr(stringBuilder)->Append2(::STRINGS[45/*"File name: "*/]);
        stringBuilder->AppendLine(__this->FileName());
    }

    if (__this->LineNumber() >= 0)
    {
        uPtr(stringBuilder)->Append2(::STRINGS[46/*"Line number: "*/]);
        stringBuilder->AppendLine(::g::Uno::Int::ToString(__this->LineNumber(), ::TYPES[47/*int*/]));
    }

    if (!::g::Uno::String::IsNullOrEmpty(__this->SourceLine()))
    {
        uPtr(stringBuilder)->Append2(::STRINGS[47/*"Source line: "*/]);
        stringBuilder->AppendLine(__this->SourceLine());
    }

    if (!::g::Uno::String::IsNullOrEmpty(__this->JSStackTrace()))
    {
        uPtr(stringBuilder)->Append2(::STRINGS[48/*"JS stack tr...*/]);
...
void ScriptMethod1__Call_fn(ScriptMethod1* __this, ::g::Fuse::Scripting::Context* c, uObject* obj, uArray* args, uObject** __retval)
{
    ...
    if (__this->Thread == 2)
    {
        ...
        {
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[49/*"Cannot call...*/], __this, ::STRINGS[30/*"/Users/code...*/], 1582, ::STRINGS[50/*"Call"*/]);
            return *__retval = NULL, void();
        }
...
{
    ScriptModule::ModuleContainsAnErrorMessage_ = ::STRINGS[51/*"require(): ...*/];
}

static void ScriptModule_build(uType* type)
{
    ::STRINGS[51] = uString::Const("require(): module contains an error: ");
    ::STRINGS[52] = uString::Const(".js");
    ::STRINGS[11] = uString::Const("");
    ::STRINGS[53] = uString::Const(".");
    ::STRINGS[54] = uString::Const("/");
    ::STRINGS[55] = uString::Const("..");
    ::STRINGS[56] = uString::Const("(function(");
    ::STRINGS[57] = uString::Const(") { ");
    ::STRINGS[58] = uString::Const("\n"
        " })");
    ::STRINGS[59] = uString::Const("Could not evaluate module '");
    ::STRINGS[60] = uString::Const("': JavaScript code contains errors");
    ::STRINGS[25] = uString::Const("exports");
    ::STRINGS[61] = uString::Const("module, exports, require");
    ::STRINGS[62] = uString::Const("/index.js");
    ::TYPES[55] = ::g::Fuse::Scripting::IModuleProvider_typeof();
    ::TYPES[56] = ::g::Uno::Char_typeof()->Array();
    ::TYPES[57] = ::g::Uno::Collections::List_typeof()->MakeType(uObject_typeof(), NULL);
    ::TYPES[8] = ::g::Fuse::Scripting::Function_typeof();
    ::TYPES[13] = ::g::Fuse::Scripting::Callback_typeof();
    ::TYPES[58] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::IO::BundleFile_typeof(), NULL);
    ::TYPES[59] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[60] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::IO::BundleFile_typeof(), NULL);
    ::TYPES[61] = ::g::Uno::Predicate_typeof()->MakeType(uObject_typeof(), NULL);
    ::TYPES[62] = ::g::Uno::UX::BundleFileSource_typeof();
    type->SetInterfaces(
...
void ScriptModule__Evaluate_fn(ScriptModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result)
{
    ...
    if (moduleFunc == NULL)
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[59/*"Could not e...*/], __this->FileName()), ::STRINGS[60/*"': JavaScri...*/])));
...
void ScriptModule__GenerateArgs_fn(ScriptModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result, ::g::Uno::Collections::List* args, uString** __retval)
{
    ...
    ::g::Uno::Collections::List__Add_fn(args, uPtr(module)->Item(::STRINGS[25/*"exports"*/]));
...
// public generated ScriptModule New() :1749
...
::g::Uno::IO::Bundle* ScriptModule::Bundle()
{
    ...
    ::g::Uno::UX::BundleFileSource* bfs = uAs< ::g::Uno::UX::BundleFileSource*>(File(), ::TYPES[62/*Uno.UX.BundleFileSource*/]);
...
uString* ScriptModule::ComputePath(uString* moduleId, bool* isFile)
{
    ...
    if (::g::Uno::String::EndsWith(uPtr(moduleId), ::STRINGS[52/*".js"*/]))
        moduleId = ::g::Uno::String::Replace1(uPtr(moduleId), ::STRINGS[52/*".js"*/], ::STRINGS[11/*""*/]);

    if (::g::Uno::String::StartsWith(uPtr(moduleId), ::STRINGS[53/*"."*/]))
    {
        *isFile = true;
        return ScriptModule::ComputePath1(GetSourcePath(), moduleId);
    }
    else if (::g::Uno::String::StartsWith(uPtr(moduleId), ::STRINGS[54/*"/"*/]))
    {
        *isFile = true;
        return ScriptModule::ComputePath1(::STRINGS[11/*""*/], moduleId);
    }
...
uString* ScriptModule::GetSourcePath()
{
    ...
    if (::g::Uno::String::op_Inequality(FileName(), NULL))
        return ::g::Uno::String::Trim1(uPtr(::g::Uno::String::Replace(uPtr(::g::Uno::IO::Path::GetDirectoryName(FileName())), '\\', '/')), uArray::Init<int>(::TYPES[56/*char[]*/], 1, '/'));
    else
        return ::STRINGS[11/*""*/];
}
...
::g::Uno::IO::BundleFile* ScriptModule::LookForFile(uString* path)
{
    ...
    if (Bundle() != NULL)
        ...
        for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(uPtr(Bundle())->Files()), ::TYPES[58/*Uno.Collections.IEnumerable<Uno.IO.BundleFile>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[59/*Uno.Collections.IEnumerator*/])); )
        {
            ::g::Uno::IO::BundleFile* f = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[60/*Uno.Collections.IEnumerator<Uno.IO.BundleFile>*/]), &ret4), ret4);

            if (ScriptModule::IsPathEqual(uPtr(f)->SourcePath(), path))
                return f;
        }

    for (uObject* enum2 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(::g::Uno::IO::Bundle::AllFiles()), ::TYPES[58/*Uno.Collections.IEnumerable<Uno.IO.BundleFile>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum2), ::TYPES[59/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Uno::IO::BundleFile* f1 = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum2), ::TYPES[60/*Uno.Collections.IEnumerator<Uno.IO.BundleFile>*/]), &ret5), ret5);
...
::g::Fuse::Scripting::Module* ScriptModule::TryResolve(uString* path, bool isFile)
{
    ...
    if (!isFile)
    {
        ...
        if (::g::Uno::UX::Resource::TryFindGlobal(path, uDelegate::New(::TYPES[61/*Uno.Predicate<object>*/], (void*)ScriptModule__Acceptor_fn, this), &res))
        {
            uObject* mp = (uObject*)res;
            return ::g::Fuse::Scripting::IModuleProvider::GetModule(uInterface(uPtr(mp), ::TYPES[55/*Fuse.Scripting.IModuleProvider*/]));
        }
    }
...
uString* ScriptModule::ComputePath1(uString* sourcePath, uString* moduleId)
{
    ...
    uArray* parts = ::g::Uno::String::Split(uPtr(moduleId), uArray::Init<int>(::TYPES[56/*char[]*/], 1, '/'));

    for (int i = 0; i < uPtr(parts)->Length(); i++)
        if (::g::Uno::String::op_Equality(uPtr(parts)->Strong<uString*>(i), ::STRINGS[11/*""*/]))
            continue;
        else if (::g::Uno::String::op_Equality(uPtr(parts)->Strong<uString*>(i), ::STRINGS[53/*"."*/]))
            continue;
        else if (::g::Uno::String::op_Equality(uPtr(parts)->Strong<uString*>(i), ::STRINGS[55/*".."*/]))
            sourcePath = ::g::Uno::String::Replace(uPtr(::g::Uno::IO::Path::GetDirectoryName(sourcePath)), '\\', '/');
        else if (uPtr(sourcePath)->Length() > 0)
            sourcePath = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(sourcePath, ::STRINGS[54/*"/"*/]), uPtr(parts)->Strong<uString*>(i));
        else
...
bool ScriptModule::IsPathEqual(uString* src, uString* path)
{
    ...
    if (::g::Uno::String::op_Equality(src, ::g::Uno::String::op_Addition2(path, ::STRINGS[52/*".js"*/])))
        return true;

    if (::g::Uno::String::op_Equality(src, ::g::Uno::String::op_Addition2(path, ::STRINGS[62/*"/index.js"*/])))
        return true;

    return false;
}

// public generated ScriptModule New() [static] :1749
...
{
    ::STRINGS[63] = uString::Const("ScriptProperty: incorrect owner type");
    type->SetPrecalc(
        type->T(0));
    type->SetFields(2,
...
void ScriptProperty1__GetProperty_fn(ScriptProperty1* __this, ::g::Uno::UX::PropertyObject* owner, ::g::Uno::UX::Property** __retval)
{
    ...
    if (!uIs(owner, __types[0]))
        U_THROW(::g::Uno::Exception::New2(::STRINGS[63/*"ScriptPrope...*/]));
...
static void Value_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction("ToNumber", NULL, (void*)Value__ToNumber_fn, 0, true, ::TYPES[50/*double*/], 1, uObject_typeof()));
}
...
double Value::ToNumber(uObject* obj)
{
    ...
    if (uIs(obj, ::TYPES[50/*double*/]))
        return uUnbox<double>(::TYPES[50/*double*/], obj);

    if (uIs(obj, ::TYPES[49/*float*/]))
        return (double)uUnbox<float>(::TYPES[49/*float*/], obj);

    if (uIs(obj, ::TYPES[47/*int*/]))
        return (double)uUnbox<int>(::TYPES[47/*int*/], obj);

    if (uIs(obj, ::TYPES[63/*uint*/]))
        return (double)uUnbox<uint32_t>(::TYPES[63/*uint*/], obj);
