...
// /Users/coder/Library/Application Support/Fusetools/Packages/Fuse.Controls.Primitives/0.47.7/$.uno
// -------------------------------------------------------------------------------------------------
...
// public generated ShadowElement() :741
void ShadowElement__ctor_4_fn(ShadowElement* __this)
{
    __this->ctor_4();
}

// protected override sealed Fuse.VisualBounds CalcRenderBounds() :837
...
// protected override sealed void OnUnrooted() :760
...
// public generated ShadowElement() [instance] :741
...
// public float4 get_Color() [instance] :826
::g::Uno::Float4 ShadowElement::Color()
{
    return _color;
}

// public void set_Color(float4 value) [instance] :827
...
// private float4 get_CornerRadius() [instance] :799
...
// private float get_MaxSize() [instance] :812
float ShadowElement::MaxSize()
{
    return ::g::Uno::Math::Min1(ActualSize().X, ActualSize().Y);
}

// public float get_Size() [instance] :785
float ShadowElement::Size()
{
    return _size;
}

// public void set_Size(float value) [instance] :786
...
// private float get_Smoothness() [instance] :816
...
// public generated ShadowElement New() [static] :741
