...
// public static extern class Support :946
// {
...
// public static extern Uno.Platform.iOS.uCGPoint CGPointFromUnoFloat2(float2 unoPoint, float scale) :1065
...
// public static extern Uno.Platform.iOS.uCGPoint CGPointFromUnoInt2(int2 unoPoint, float scale) :1057
...
// public static extern int2 CGPointToUnoInt2(Uno.Platform.iOS.uCGPoint point, float scale) :1049
...
// public static extern Uno.Platform.iOS.uCGRect CGRectFromUnoRect(Uno.Rect unoRect, float scale) :1073
...
// public static extern Uno.Platform.iOS.uCGRect CGRectFromUnoRecti(Uno.Recti unoRect, float scale) :1083
...
// public static extern Uno.Recti CGRectToUnoRecti(Uno.Platform.iOS.uCGRect rect, float scale) :1094
...
// public static extern Uno.Platform.iOS.uCGSize CGSizeFromUnoFloat2(float2 unoSize, float scale) :1118
...
// public static extern Uno.Platform.iOS.uCGSize CGSizeFromUnoInt2(int2 unoSize, float scale) :1110
...
// public static extern int2 CGSizeToUnoInt2(Uno.Platform.iOS.uCGSize size, float scale) :1101
void Support__CGSizeToUnoInt2_fn(CGSize* size, float* scale, ::g::Uno::Int2* __retval)
{
    *__retval = Support::CGSizeToUnoInt2(*size, *scale);
}

// public static texture2D CreateTextureFromImage(Uno.Platform.iOS.UIImage image) :948
...
// private static int2 UIImageGetSize(Uno.Platform.iOS.UIImage image) :959
void Support__UIImageGetSize_fn(::UIImage ** image, ::g::Uno::Int2* __retval)
{
    *__retval = Support::UIImageGetSize(*image);
}

// private static byte[] UIImageToRGBA8888(Uno.Platform.iOS.UIImage _image) :969
void Support__UIImageToRGBA8888_fn(::UIImage ** _image, uArray** __retval)
{
    *__retval = Support::UIImageToRGBA8888(*_image);
}

// public static extern Uno.Platform.iOS.uCGPoint CGPointFromUnoFloat2(float2 unoPoint, float scale) [static] :1065
...
// public static extern Uno.Platform.iOS.uCGPoint CGPointFromUnoInt2(int2 unoPoint, float scale) [static] :1057
...
// public static extern int2 CGPointToUnoInt2(Uno.Platform.iOS.uCGPoint point, float scale) [static] :1049
...
// public static extern Uno.Platform.iOS.uCGRect CGRectFromUnoRect(Uno.Rect unoRect, float scale) [static] :1073
...
// public static extern Uno.Platform.iOS.uCGRect CGRectFromUnoRecti(Uno.Recti unoRect, float scale) [static] :1083
...
// public static extern Uno.Recti CGRectToUnoRecti(Uno.Platform.iOS.uCGRect rect, float scale) [static] :1094
...
// public static extern Uno.Platform.iOS.uCGSize CGSizeFromUnoFloat2(float2 unoSize, float scale) [static] :1118
...
// public static extern Uno.Platform.iOS.uCGSize CGSizeFromUnoInt2(int2 unoSize, float scale) [static] :1110
...
// public static extern int2 CGSizeToUnoInt2(Uno.Platform.iOS.uCGSize size, float scale) [static] :1101
...
// public static texture2D CreateTextureFromImage(Uno.Platform.iOS.UIImage image) [static] :948
...
// private static int2 UIImageGetSize(Uno.Platform.iOS.UIImage image) [static] :959
...
// private static byte[] UIImageToRGBA8888(Uno.Platform.iOS.UIImage _image) [static] :969
