...
// /Users/coder/Library/Application Support/Fusetools/Packages/Fuse.Reactive.Expressions/0.47.7/$.uno
// --------------------------------------------------------------------------------------------------
...
// /Users/coder/Library/Application Support/Fusetools/Packages/Fuse.Reactive.JavaScript/0.47.7/$.uno
// -------------------------------------------------------------------------------------------------
...
// /Users/coder/Library/Application Support/Fusetools/Packages/Fuse.Reactive.Bindings/0.47.7/$.uno
// -----------------------------------------------------------------------------------------------
...
static void FunctionMirror__CallClosure_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("/Users/coder/Library/Application Support/Fusetools/Packages/Fuse.Reactive.JavaScript/0.47.7/$.uno");
...
void FunctionMirror__CallClosure::Call()
{
    ...
    catch (const uThrowable& __t)
    {
        if (uIs(__t.Exception, ::TYPES[11/*Fuse.Scripting.ScriptException*/]))
        {
            ...
            ::g::Fuse::Reactive::JavaScript::UserScriptError(::STRINGS[5/*"JavaScript ...*/], ex, this, ::STRINGS[6/*"/Users/code...*/], 200, ::STRINGS[7/*"Call"*/]);
        }
        else throw __t;
    }
}
...
// /Users/coder/Library/Application Support/Fusetools/Packages/Fuse.Reactive.JavaScript/0.47.7/fusejs/$.uno
// --------------------------------------------------------------------------------------------------------
...
{
    ::STRINGS[13] = uString::Const("/Users/coder/Library/Application Support/Fusetools/Packages/Fuse.Reactive.JavaScript/0.47.7/fusejs/$.uno");
...
uObject* Console::Dir(uArray* args)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(builder->ToString(), 1, ::STRINGS[13/*"/Users/code...*/], 135);
    return NULL;
}
...
uObject* Console::Log(uArray* args)
{
    ...
    for (int i = 0; i < uPtr(args)->Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)->Strong<uObject*>(i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)->Strong<uObject*>(i))) : ::STRINGS[14/*"null"*/], 1, ::STRINGS[13/*"/Users/code...*/], 121);
...
static void DataBinding_build(uType* type)
{
    ...
    ::STRINGS[33] = uString::Const("/Users/coder/Library/Application Support/Fusetools/Packages/Fuse.Reactive.Bindings/0.47.7/$.uno");
...
void DataBinding::TryPushAsMarshalledValue(uObject* newValue)
{
    ...
    if (::g::Fuse::Marshal::TryConvertTo(uPtr(Target())->PropertyType(), newValue, &res, this))
    {
        ...
        catch (const uThrowable& __t)
        {
            ...
            ::g::Fuse::Diagnostics::UserError(e->ToString(), Target(), ::STRINGS[33/*"/Users/code...*/], 409, ::STRINGS[35/*"TryPushAsMa...*/], NULL);
        }
    }
}
...
// /Users/coder/Library/Application Support/Fusetools/Packages/Fuse.Reactive.Bindings/0.47.7/subscription/$.uno
// ------------------------------------------------------------------------------------------------------------
...
uObject* DebugLog::Log(uArray* args)
{
    ...
    for (int i = 0; i < uPtr(args)->Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)->Strong<uObject*>(i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)->Strong<uObject*>(i))) : ::STRINGS[14/*"null"*/], 1, ::STRINGS[13/*"/Users/code...*/], 99);
...
// /Users/coder/Library/Application Support/Fusetools/Packages/Fuse.Reactive/0.47.7/$.uno
// --------------------------------------------------------------------------------------
...
void Instantiator::AddTemplate(uObject* data, ::g::Uno::UX::Template* f, ::g::Uno::Collections::List* newElements)
{
    ...
    if (elm == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[47/*"Template co...*/], this, ::STRINGS[33/*"/Users/code...*/], 1455, ::STRINGS[48/*"AddTemplate"*/]);
        return;
    }
...
void Instantiator::Limit(int value)
{
    ...
    if (value < 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[49/*"Limit canno...*/], this, ::STRINGS[33/*"/Users/code...*/], 1033, ::STRINGS[50/*"set_Limit"*/], NULL);
        value = 0;
    }
...
void Instantiator::Offset(int value)
{
    ...
    if (value < 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[51/*"Offset cann...*/], this, ::STRINGS[33/*"/Users/code...*/], 985, ::STRINGS[52/*"set_Offset"*/], NULL);
        value = 0;
    }
...
void JavaScript::EvaluateModule()
{
...

    {
        ...
        if (newModuleResult->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[54/*"JavaScript ...*/], FileName()), ::STRINGS[55/*" fixed!"*/]), this, ::STRINGS[6/*"/Users/code...*/], 415, ::STRINGS[56/*"EvaluateMod...*/]);
        ...
        else
        {
            ...
            {
                JavaScript::UserScriptError(::STRINGS[57/*"JavaScript ...*/], se, this, ::STRINGS[6/*"/Users/code...*/], 426, ::STRINGS[56/*"EvaluateMod...*/]);
...
{
    ctor_5();
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[110/*"'Select' is...*/], this, ::STRINGS[33/*"/Users/code...*/], 2283, ::STRINGS[111/*".ctor"*/]);
}
...
void Observable__Subscription::SetExclusive(uObject* newValue)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[113/*"Unexpected ...*/], this, ::STRINGS[6/*"/Users/code...*/], 607, ::STRINGS[114/*"SetExclusive"*/]);
        return;
    }
    ...
    catch (const uThrowable& __t)
    {
        ...
        {
            ::g::Fuse::Scripting::ScriptException* ex = (::g::Fuse::Scripting::ScriptException*)__t.Exception;
            ::g::Fuse::Reactive::JavaScript::UserScriptError(::STRINGS[116/*"Failed to s...*/], ex, this, ::STRINGS[6/*"/Users/code...*/], 619, ::STRINGS[114/*"SetExclusive"*/]);
        }
        else throw __t;
    }
}
...
void ThreadWorker::CheckAndThrow()
{
    ...
    {
        if (prev != NULL)
            ::g::Fuse::Diagnostics::UnknownException(::STRINGS[120/*"Skipped Exc...*/], next, this, ::STRINGS[6/*"/Users/code...*/], 1820, ::STRINGS[121/*"CheckAndThrow"*/]);
...
uObject* ThreadWorker::CreateMirror(uObject* obj)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[122/*"JavaScript ...*/], this, ::STRINGS[6/*"/Users/code...*/], 1390, ::STRINGS[123/*"CreateMirror"*/]);
        return NULL;
    }
...
void ThreadWorker::Run()
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Fuse::Diagnostics::UnknownException(::STRINGS[134/*"ThreadWorke...*/], e, this, ::STRINGS[6/*"/Users/code...*/], 1716, ::STRINGS[135/*"Run"*/]);
