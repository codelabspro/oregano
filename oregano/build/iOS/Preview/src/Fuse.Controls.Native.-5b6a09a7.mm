...
void NativeViewRenderer::Draw(::g::Fuse::Controls::Native::ViewHandle* viewHandle, ::g::Uno::Float4x4 localToClipTransform, ::g::Uno::Float2 position, ::g::Uno::Float2 size, float density)
{
    ...
    if (!_valid)
    {
        ...
        NativeViewRenderer::Upload(uPtr(viewHandle)->NativeHandle, ::g::OpenGL::GLTextureHandle::op_Explicit1(_textureHandle), uUnbox<void*>(::g::Uno::IntPtr_typeof(), _pixelBuffer), pixelSize.X, pixelSize.Y, density, reuse);
