// This file was generated based on '/Users/coder/Library/Application Support/Fusetools/Packages/Fuse.Controls.WebView/0.47.7/ios/$.uno'.
...
static void NavDelegate_build(uType* type)
{
    type->Reflection.SetFunctions(1,
        new uFunction("Create", NULL, (void*)NavDelegate__Create_fn, 0, true, ::g::ObjC::Object_typeof(), 5, ::g::Uno::Action_typeof(), ::g::Uno::Action_typeof(), ::g::Uno::Action_typeof(), ::g::Uno::Action1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), ::g::Uno::String_typeof()->Array()));
}
