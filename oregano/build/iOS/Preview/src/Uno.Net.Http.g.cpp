...
// /Users/coder/Library/Application Support/Fusetools/Packages/Uno.Net.Http/0.47.13/uriparsers/$.uno
// -------------------------------------------------------------------------------------------------
...
// /Users/coder/Library/Application Support/Fusetools/Packages/Uno.Net.Http/0.47.13/$.uno
// --------------------------------------------------------------------------------------
...
static void HttpMessageCache_build(uType* type)
{
    ...
    ::STRINGS[23] = uString::Const("/Users/coder/Library/Application Support/Fusetools/Packages/Uno.Net.Http/0.47.13/$.uno");
...
void HttpMessageCache::IsCacheEnabled(bool value)
{
    ...
    if (HttpMessageCache::_isInitialized())
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[22/*"Uno.Net.Htt...*/], 1, ::STRINGS[23/*"/Users/code...*/], 17);
    else
...
void HttpMessageCache::MaxCacheSizeInBytes(int64_t value)
{
    ...
    if (HttpMessageCache::_isInitialized())
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[24/*"Uno.Net.Htt...*/], 1, ::STRINGS[23/*"/Users/code...*/], 30);
    else
