...
// /Users/coder/Library/Application Support/Fusetools/Packages/UnoCore/0.47.13/source/uno/runtime/implementation/shaderbackends/opengl/$.uno
// -----------------------------------------------------------------------------------------------------------------------------------------
...
// public static void TexImage2DFromIntPtr(OpenGL.GLTextureTarget target, int w, int h, int mip, Uno.Graphics.Format format, Uno.IntPtr data) :692
...
// public static void TexImage2DFromIntPtr(OpenGL.GLTextureTarget target, int w, int h, int mip, Uno.Graphics.Format format, Uno.IntPtr data) [static] :692
void GLHelpers::TexImage2DFromIntPtr(int target, int w, int h, int mip, int format, void* data)
{
