...
// /Users/coder/Library/Application Support/Fusetools/Packages/Fuse.Motion/0.47.7/$.uno
// ------------------------------------------------------------------------------------
...
static void DestinationMotion_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/Users/coder/Library/Application Support/Fusetools/Packages/Fuse.Motion/0.47.7/$.uno");
...
uObject* DestinationMotion::Create()
{
    ...
    switch (Type())
    {
        ...
        default:
        {
            ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition1(::STRINGS[0/*"Invalidate ...*/], uBox<int>(::g::Fuse::Motion::MotionDestinationType_typeof(), Type())), this, ::STRINGS[1/*"/Users/code...*/], 401, ::STRINGS[2/*"Create"*/], NULL);
